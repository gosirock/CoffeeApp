...
public class Lju_Dao_Menu_Drink {
	...
	public Lju_Dao_Menu_Drink(String iid, String iname, int iprice, String iimagename) {
		super();
		this.iid = iid;
		this.iname = iname;
		this.iprice = iprice;
	...
	public Lju_Dao_Menu_Drink(String iname) {
		super();
		this.iname = iname;
	}
	...
	public ArrayList<Lju_dto> selectLinst(){
		...
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage from item where iid like '%b%'";
	...
	public ArrayList<Lju_dto> SearchAction(){
		...
		String whereDefault1 = " where iid like '%b%' and iname like '%" + iname + "%'";
	...
	public ArrayList<Lju_dto> Linst(){
		...
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage, iid from item where iid like '%b%'";
