...
public class Lju_Dao_Menu_Dessert {
	...
	public Lju_Dao_Menu_Dessert(String iid, String iname, int iprice, String iimagename) {
		super();
		this.iid = iid;
		this.iname = iname;
		this.iprice = iprice;
	...
	public Lju_Dao_Menu_Dessert(String iname) {
		super();
		this.iname = iname;
	}
	...
	public ArrayList<Lju_dto> selectLinst(){
		...
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage from item where iid like '%c%'";
	...
	public ArrayList<Lju_dto> SearchAction(){
		...
		String whereDefault1 = " where iid like '%c%' and iname like '%" + iname + "%'";
	...
	public ArrayList<Lju_dto> Linst(){
		...
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage, iid from item where iid like '%c%'";
