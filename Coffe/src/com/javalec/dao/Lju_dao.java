...
public class Lju_dao {
	...
	public Lju_dao(String iid, String iname, int iprice, String iimagename) {
		super();
		this.iid = iid;
		this.iname = iname;
		this.iprice = iprice;
	...
	public ArrayList<Lju_dto> selectLinst(){
		...
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage from item";
	...
	public ArrayList<Lju_dto> SearchAction(){
		...
		ArrayList<Lju_dto> dtoList = new ArrayList<Lju_dto>();
		String whereDefault = "select idescription, iname, iprice, iimagename, iimage from item";
		String whereDefault1 = " where iname like '%" + iname + "%'";
