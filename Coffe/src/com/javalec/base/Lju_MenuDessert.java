...
import com.javalec.dao.Lju_Dao_Menu_Dessert;
...
public class Lju_MenuDessert extends JFrame implements ActionListener {	// 엔터키 액션넣기
...
//	"<html>안녕<br>안녀엉<p>세번</html>" 라벨 줄바꾸기
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Lju_MenuDessert frame = new Lju_MenuDessert();
	...
	private JButton getBtnHome() {
		if (btnHome == null) {
			...
			btnHome.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/btnHome.png")));
	...
	private JButton getBtnMenu() {
		if (btnMenu == null) {
			...
			btnMenu.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/btnMenu.png")));
	...
	private JButton getBtnReview() {
		if (btnReview == null) {
			...
			btnReview.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/btnReview.png")));
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			...
			lblNewLabel_1.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/wifi.png")));
	...
	private JButton getBtnCoffe() {
		if (btnCoffe == null) {
			...
			btnCoffe.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/opt 1 (3).png")));
	...
	private JButton getBtnDrink() {
		if (btnDrink == null) {
			...
			btnDrink.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/opt 2.png")));
	...
	private JButton getBtnDessert() {
		if (btnDessert == null) {
			...
			btnDessert.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/opt 3 (1).png")));
	...
	private JLabel getLblNewLabel_4() {
		if (lblNewLabel_4 == null) {
			...
			lblNewLabel_4.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/options.png")));
	...
	private JLabel getLblclickimg() {
		if (lblclickimg == null) {
			...
			lblclickimg.setBounds(0, 6, 400, 680);
	...
	private JLabel getLblBasket() {
		if (lblBasket == null) {
			...
			lblBasket.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/selectjang.png")));
	...
	private JLabel getLblgra() {
		if (lblgra == null) {
			lblgra = new JLabel("");
			lblgra.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/layer.png")));
	...
	private JLabel getLblBuy() {
		if (lblBuy == null) {
			...
			lblBuy.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/selectbaro.png")));
	...
	private JButton getBtnPlus() {
		if (btnPlus == null) {
			...
			btnPlus.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/select.png")));
	...
	private JButton getBtnMinus() {
		if (btnMinus == null) {
			...
			btnMinus.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/selectami.png")));
	...
	private JButton getBtnExit() {
		if (btnExit == null) {
			...
			btnExit.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/akar-icons_cross.png")));
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			...
			btnNewButton.setIcon(new ImageIcon(Lju_MenuDessert.class.getResource("/com/javalec/image/icon _cart_.png")));
	...
	private void searchAction() {
		...
		Lju_Dao_Menu_Dessert daoLju_dao = new Lju_Dao_Menu_Dessert();
	...
	// 텍스트 필드 엔터누르면 액션 
	 ...
	 private void SearchAction() {
		 tableInit();
		 Lju_Dao_Menu_Dessert dao = new Lju_Dao_Menu_Dessert(txtSearch.getText());
